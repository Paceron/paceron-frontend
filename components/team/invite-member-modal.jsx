...
// Sin guard de cambios sin guardar a propósito — a diferencia de
// CreateGroupModal, un email a medio escribir no amerita la fricción de
// confirmar el cierre (decisión explícita del usuario, 2026-09-10).
