...
Regla general para cualquier `AnimatedDropdown` futuro anidado dentro de una lista/fila (no un header/shell cerca de la raíz): NUNCA montarlo por-fila con `measureInWindow` crudo — medir contra un contenedor de referencia estable y restar, montar el dropdown una sola vez en ese nivel.
