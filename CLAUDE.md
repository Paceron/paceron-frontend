...
Moraleja: `Gesture.Native()` resuelve arbitraje "esta fila vs. su contenedor scrolleable" Y arbitraje "este control puntual vs. la fila que lo envuelve" — pero son dos aplicaciones separadas, hay que ponerlo en cada nivel donde haga falta, no alcanza con uno solo arriba de todo.
